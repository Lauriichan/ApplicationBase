package me.lauriichan.applicationbase.test.ui;
...
public final class ImGuiStyler {
    ...
    private static void applyColors(ImGuiStyle style) {
        ...
        style.setColor(ImGuiCol.FrameBg, 0.79f, 0.02f, 0.42f, 0.64f);
        style.setColor(ImGuiCol.FrameBgHovered, 1.00f, 0.45f, 0.73f, 0.54f);
        style.setColor(ImGuiCol.FrameBgActive, 0.98f, 0.00f, 0.32f, 0.67f);
        style.setColor(ImGuiCol.TitleBg, 0.04f, 0.04f, 0.04f, 1.00f);
        style.setColor(ImGuiCol.TitleBgActive, 0.33f, 0.04f, 0.22f, 1.00f);
