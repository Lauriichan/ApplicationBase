...
public final class ConfigWrapper<T extends IConfigExtension> implements IConfigWrapper<T> {
    ...
    public static <S extends ISingleConfigExtension> ConfigWrapper<S> single(final BaseApp plugin, final S extension) {
    ...
    public ConfigWrapper(final BaseApp plugin, final T extension, final String path) {
