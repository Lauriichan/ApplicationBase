...
public final class DataWrapper<T, D extends IFileDataExtension<T>> implements IDataWrapper<T, D> {
    ...
    public static <T, D extends ISingleDataExtension<T>> DataWrapper<T, D> single(final BaseApp app, final D extension) {
    ...
    public DataWrapper(final BaseApp app, final D extension, final String path) {
