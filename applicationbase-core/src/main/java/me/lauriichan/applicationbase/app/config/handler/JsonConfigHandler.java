package me.lauriichan.applicationbase.app.config.handler;
...
import me.lauriichan.applicationbase.app.io.serialization.json.JsonSerializationHandler;
...
public final class JsonConfigHandler implements IConfigHandler {
    ...
    private JsonConfigHandler() {
        ...
        ioManager = BaseApp.get().ioManager();
    }
